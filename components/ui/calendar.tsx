...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "p-6 bg-gradient-to-b from-white/50 to-pink-50/30 rounded-2xl backdrop-blur-sm",
        className,
      )}
      classNames={{
        ...
        caption_label:
          "text-lg font-playfair font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-rose-500",
        ...
        head_row: "flex gap-2",
        head_cell:
          "text-pink-600 font-playfair rounded-md w-9 font-semibold text-xs tracking-wide",
        ...
        day_selected:
          "bg-gradient-to-br from-pink-500 to-rose-500 text-white font-semibold shadow-lg shadow-pink-300/40 hover:from-pink-600 hover:to-rose-600",
